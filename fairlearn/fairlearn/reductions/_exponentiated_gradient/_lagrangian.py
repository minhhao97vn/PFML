...
class _Lagrangian:
    ...
    def __init__(self, X, A, y, learner, constraints, eps, B, sw=None, opt_lambda=True, **kw):
        self.X = X
        self.constraints = constraints
        self.constraints.load_data(X, y, sensitive_features=A, sw=sw)
        self.obj = self.constraints.default_objective()
        self.obj.load_data(X, y, sensitive_features=A, sw=sw)
...
#         print(redW)
        ...
        if h_value < best_value - _PRECISION:
            ...
            self.sample_weights[h_idx] = redW
